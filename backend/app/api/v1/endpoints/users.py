...
def read_user_by_id(
    ...
    if current_user.role not in [UserRole.ADMIN, UserRole.SUPER_ADMIN] and current_user.id != id:
        raise HTTPException(
...
def update_profile(
    ...
    return {"success": True, "data": UserResponse.model_validate(updated_user), "message": "Profile updated successfully."}
...
def change_user_role(
    ...
    return {"success": True, "data": UserResponse.model_validate(updated_user), "message": "User role updated successfully."}
...
def change_user_status(
    ...
    return {"success": True, "data": UserResponse.model_validate(updated_user), "message": "User status updated successfully."}
