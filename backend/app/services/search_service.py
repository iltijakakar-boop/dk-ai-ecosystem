...
class SearchService:
    ...
    invokes vector store drivers, maps results to
    document chunks, and audits performance.
    """
    ...
    def search_similarity(
        ...
        """
        Executes a similarity search, returning matching
        text blocks with scoring metrics.
        """
        db = SessionLocal()
        ...
        try:
            ...
            scored_matches = store.search(
                query_embedding=query_vector, top_k=top_k, filters=filters
            )
