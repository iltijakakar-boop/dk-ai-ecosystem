...
class TextExtractor:
    ...
    def extract_text(file_path: str, mime_type: str) -> str:
        """
        Extracts plain text contents of a document from
        file_path depending on file type/MIME.
        """
        ...
        # 3. DOCX Microsoft Word Files (via python-docx)
            ...
            try:
                ...
                raise ImportError(
                    "python-docx package is required to parse DOCX documents."
                )
        ...
        # Fallback raw reading
            ...
            try:
                ...
                raise ValueError(
                    f"Unsupported file format and text"
                    f" extraction failed: {ext}"
                    f" (MIME: {mime_type})"
                )
